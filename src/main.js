...
createRoot(document.getElementById("root")).render(_jsx(GoogleOAuthProvider, { clientId: import.meta.env.VITE_GOOGLE_ID, children: _jsx(Provider, { store: store, children: _jsx(DataProvider, { children: _jsx(RouterProvider, { router: router }) }) }) }));
