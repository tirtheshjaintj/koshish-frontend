...
const FacultyForm: React.FC<FacultyFormProps> = ({
  ...
  return (
    <form
      ...
      className="space-y-6 w-full max-w-lg mx-auto shadow-lg rounded-lg bg-white  p-6"
    >
      {/* Title */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            className="w-full mt-1 p-2 rounded-md border border-stone-300 dark:border-stone-700 bg-white  text-stone-800  focus:outline-none focus:ring-1 focus:ring-emerald-800"
            value={data?.name || ""}
